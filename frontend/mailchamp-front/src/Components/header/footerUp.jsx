  ...
  return (
    <div className="outer">
      ...
      <div className="ecommerce">
        <div className="free">
          <p>FREE GUIDE</p>
          <h1>E-commerce Time Savers</h1>
          <p>
            Use these powerful automations to drive customer loyalty and repeat
            business, while saving time.
          </p>
          <p id="learnmr2">Learn More</p>
        </div>
        <div className="imges">
          <div className="girl_img">
            <div>
              <img
                src="https://eep.io/images/yzco4xsimv0y/185jQxfZHnXRFyd7qwhC3h/4a6116f0da1337f4c962e908ca335ac8/MCP_Going-Through-It_Logout_MCP-Homepage-Grid-Quadrant.jpg?w=780&fm=webp&q=80"
                alt=""
              />
            </div>
            <div className="logoimage">
              <img
                src="https://eep.io/images/yzco4xsimv0y/4GB4ccyPMbWUX4aYbzIlo9/5f045fc4120b8afb030036e3ce8136e9/mcp-horizontal.png?w=240&fm=webp&q=80"
                alt=""
              />
            </div>
          </div>
          <div className="podcast">
            <p>PODCASTS</p>
            <h2>Going Through It</h2>
            <p>
              Our new host Jenny Yang sits down with 15 notable guests to
              reflect on how advice from an elder at a pivotal moment helped
              define each guest’s life and career.
            </p>
            <p id="learnmr">Listen Now</p>
          </div>
        </div>
      </div>
      <div className="courier">
        <div className="frstImg">
          <img
            src="https://eep.io/images/yzco4xsimv0y/5EuVrCjm1v1ZR5nuF1MmKw/9c6556799ba41424645487291f6c0480/Homepage-Grid-10-19-Courier.jpg?w=780&fm=webp&q=80"
            alt=""
          />
          ...
          <div className="bottom-left">
            <h2>How to Make a Creative Business Fly</h2>
            <p>Get the New Issue</p>
          </div>
        </div>
        <div className="seconddv">
          <div>
            <img
              src="https://eep.io/images/yzco4xsimv0y/6fpvnrBogbSGpbPKzIUsEW/40f0e23b90e188b7372c942017067992/Homepage-Grid-Bloom-Season.png?w=780&fm=webp&q=80"
              alt=""
            />
          </div>
          <div className="business">
            <p id="business">BUSINESS TIPS</p>
            <h2>Welcome to Bloom Season</h2>
            <p>
              A space for conversations on family, social justice, wellness, and
              business, designed to help entrepreneurs of color thrive.
            </p>
            <p id="learnmr">Learn more</p>
          </div>
        </div>
      </div>
      {/* <div className="letsdothis1">
        <div className="letsdothis">
          <h1>Let’s do this</h1>
          <p>Every big idea starts with a small step forward.</p>
          <button id="btnpick">Pick A Plan</button>
        </div>
      </div> */}
      <div className="footerall">
        <div className="related">
          <div id="rel2">
            ...
            <p>How To Make a Website: A Guide for Building Your Website</p>

            <p>How To Start an E‑Commerce Business—a Complete Guide</p>

            <p>How To Sell to Any Audience</p>
          </div>
        </div>
        ...
        <div style={{ display: "flex" }}>
          ...
          <div className="footerIcon">
            <div className="prodcts2">
              ...
              <p id="learnmr">Check it out</p>
            </div>
            <div className="prodcts2" id="lower">
              <img
        ...
        <div className="footerdown">
          <div className="footerdown2">
            ...
            <div className="tradmarkinfo">
              <select className="language" name="" id="">
                <option value="English">English</option>
                <option value="Espanol">Espanol</option>
                <option value="Franscois">Franscois</option>
                <option value="Portugies">Portugies</option>
                <option value="Desutch">Desutch</option>
              ...
              <p>
                ...
                of Google Inc.
                <a>Privacy</a> | <a>Terms</a> | <a>Cookie Preference</a>
              </p>
            </div>
          </div>
        </div>
